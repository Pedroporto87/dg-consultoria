      ...
      <div className='form-conteiner'>
        ...
        <div className='formulario'>
          ...
          <form className='formulario-input' onSubmit={handleSubmit}>
            <label htmlFor='nome' className='form-label'> Nome: 
              <input type='text' className='form-input'  placeholder='Nome' value={form.nome} required onChange={handleChange} />
            </label>
            <br />
            <label htmlFor='email' className='form-label'> E-mail:
              <input type='email' className='form-input' placeholder='E-mail' value={form.email} required onChange={handleChange} />
            </label>
            <br />
            <label htmlFor='assunto' className='form-label'>Assunto: 
              <input type='assunto' className='form-input' placeholder='No que podemos ajudar?' value={form.assunto} onChange={handleChange} />
            </label>
            <br />
            <label htmlFor='telefone'className='form-label'>Telefone:
              <input type='tel'id='telefone' className='form-input' placeholder='(00)0000-0000' pattern='([0-9]{2})[0-9]{4}-[0-9]{4}' 
                value={form.telefone} onChange={handleChange} />
            </label>
            <br />
            <label htmlFor='celular' className='form-label'>Celular: 
              <input type='tel' className='form-input' placeholder='(00)00000-0000' pattern='([0-9]{2})[0-9]{5}-[0-9]{4}'
